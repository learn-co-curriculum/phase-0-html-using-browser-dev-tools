...
Feel free to play around, check and uncheck boxes, change colors, change pixels. It's ok if you "mess things up", just refresh the browser and it will all go back to how it was!
